...
const Footer = ({
  ...
  return (
    <footer
      className={`self-stretch h-[32.487rem] bg-gray1-400 flex flex-col items-start justify-start pt-[0rem] px-[0rem] pb-[6.737rem] box-border gap-[0.5rem] max-w-full text-left text-[2.375rem] text-white font-dm-sans mq825:pb-[4.375rem] mq825:box-border mq1425:h-auto ${className}`}
    >
      <div className="self-stretch flex flex-row items-start justify-start pt-[7.5rem] px-[9.375rem] pb-[1.25rem] box-border relative gap-[7.125rem] shrink-0 max-w-full mq450:gap-[1.75rem] mq450:pt-[4.875rem] mq450:box-border mq825:gap-[3.563rem] mq825:pl-[2.313rem] mq825:pr-[2.313rem] mq825:box-border mq1425:flex-wrap mq1425:justify-center mq1425:pl-[4.688rem] mq1425:pr-[4.688rem] mq1425:box-border">
        <div className="w-[19.375rem] flex flex-col items-start justify-start gap-[2.5rem] min-w-[19.375rem] mq450:gap-[1.25rem] mq1425:flex-1">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[1rem] text-[0.875rem] text-lightgray font-paragraph">
        ...
        <div className="w-[35.438rem] flex flex-row items-start justify-between min-w-[35.438rem] max-w-full gap-[1.25rem] text-[1.125rem] font-paragraph lg:min-w-full mq450:flex-wrap mq1425:flex-1">
          ...
          <div className="flex flex-col items-start justify-start gap-[1.5rem]">
            <a className="[text-decoration:none] relative leading-[1.5rem] font-semibold text-[inherit] inline-block min-w-[5.25rem]">
              Company
            </a>
      ...
      <div className="self-stretch bg-gray1-300 flex flex-row items-start justify-center py-[2.375rem] px-[1.25rem] shrink-0 text-center text-[0.875rem] font-quote">
