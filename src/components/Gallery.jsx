          ...
          <div className="flex flex-col w-[51%] max-md:ml-0 max-md:w-full">
            <div className="flex relative flex-col grow justify-center p-9 min-h-[300px] rounded-[30px] max-md:px-5 max-md:mt-8 max-md:max-w-full">
              <img
                ...
                className="absolute inset-0 object-cover rounded-[30px] size-full"
              />
                ...
                <div className="flex gap-5 max-md:flex-col">
                  <div className="flex flex-col w-[81%] max-md:ml-0 max-md:w-full">
                    <div className="relative flex flex-col grow max-md:mt-10">
                      <h4 className="text-4xl font-bold text-orange-100">
                        Modern room
                      </h4>
                      <p className="mt-2.5 text-lg leading-7 text-white text-opacity-80">
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
            <img
              ...
              alt="Gallery image 3"
              className="grow w-full aspect-[1.32] rounded-[30px] max-md:mt-8"
            />
          </div>
