...
const amenities = [
  ...
  },
  {
    ...
    text: "Tea/coffee machine",
  },
];

const Amenities = () => (
  <div className="flex flex-wrap items-start gap-5 mt-8 text-base font-medium lg:gap-[15rem] max-md:max-w-full">
    ...
    <div className="flex flex-col items-start">
      ...
      {/* <div className="self-stretch mt-6 font-semibold text-sky-400">
        +24 more
      </div> */}
    </div>
  </div>
